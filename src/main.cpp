...
const string strMessageMagic = "CoinTer Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CoinTer: 1 days
static const int64 nTargetSpacing = 120; // CoinTer: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cointer miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoinTer", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4a63d0f1f2744609e6dabe3044ead523b627fe134c9f01a4be18006284893c87");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "So long and thanks for all the fish";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1500107422; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1500107422;
            block.nNonce   = 90659;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb24f6e0fb1077247eb0d16cc364d74edfb2aea800c77fe0f88b6343f2fe01d0b"));
